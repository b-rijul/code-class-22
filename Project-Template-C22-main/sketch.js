...
function setup() {
	...
	bob1 = Bodies.circle(300,280,50,bob_options);
    World.add(world,bob1);

	bob2 = Bodies.circle(350,280,50,bob_options);
    World.add(world,bob2);

	bob3 = Bodies.circle(400,280,50,bob_options);
    World.add(world,bob3);

	bob4 = Bodies.circle(450,280,50,bob_options);
    World.add(world,bob4);

	bob5 = Bodies.circle(500,280,50,bob_options);
